Ext.define('Admin.view.kinerja.IndikatorList',
				{
					extend : 'Ext.grid.Grid',
					xtype : 'indikator-capkin-list',
					...
					columns : [
						...
						{
				            text: 'Tujuan / Sasaran / Program / <br>Kegiatan / Subkegiatan',width: '250',
						...
						{text: `Target ${vTAHUN}`,dataIndex: 'target',width: 100,align: 'right'},
						{text: 'Target & Realisasi Per Triwulan',
							columns : [
								{
									text: 'Triwulan I',
									columns : [
					...
					items : [
						{
								...
								*/
								...
								items : [ 
									...
									{xtype: 'button',ui : 'soft-purple',text: 'Submit Laporan',shadow:true,iconCls: 'x-fa fa-paper-plane',margin:'0 5 0 5',handler: 'formKirim_Show',destIdx:5,style : {fontSize : '11px'}},
