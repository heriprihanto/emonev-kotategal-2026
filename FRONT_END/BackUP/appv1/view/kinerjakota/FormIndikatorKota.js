Ext.define('Admin.view.kinerja.FormIndikatorKota', {
    extend: 'Ext.form.Panel',
    reference: 'formIndikatorKinerja',xtype:'form-indikator-kota-kinerja-capkin',id:'form-indikator-kota-kinerja-capkin',jsonSubmit :true,
    ...
    items: [
        ...
        {xtype:'containerfield',defaults: {labelAlign:'top'},items:[
            {xtype: 'selectfield',flex:1,listeners: {blur : 'hitungCapkin'},
                    name: 'idjenis',
                    label: 'Jenis',
                    options: [
            ...
            {xtype: 'combobox',label: 'Tagging',placeholder: 'Tagging ...', name: 'tags',queryMode: 'local',valueField: 'tag', displayField: 'tag',striped: true,multiSelect:true,margin: '0 20',flex:4,
    ...
    tbar : [ 
        ...
        {xtype:'spacer'},
        {xtype:'component',html:'<div id="form-capkin-kota-title-009099"></div'},
