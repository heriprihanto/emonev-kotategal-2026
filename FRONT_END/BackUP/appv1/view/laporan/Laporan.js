Ext.define('Admin.view.laporan.Laporan', {
    ...
    items: [
        ...
        
        {
            ...
            //shadow:true,border:true,cls:'tab-modulpanel-cl-orange',
            height:PanelCompHeight-50,layout: {type: 'vbox',align: 'stretch'},defaultType: 'panel',scrollable: true,
            items:[
