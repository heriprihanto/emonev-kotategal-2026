Ext.define('Admin.view.personel.FormPersonel', {
	...
	items: [
			...
			{xtype:"textfield",label:"NIP :",name:"nip",required: true,
			listeners: {
				blur: function(field) {
			...
			{xtype:"emailfield",label:"Email :",name:"email",required: true},
			{xtype:"textfield",label:"No HP :",name:"phone",required: true},
