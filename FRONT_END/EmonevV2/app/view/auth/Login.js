Ext.define('Admin.view.auth.Login', {
    ...
    items: [
        ...
        <div id="x-logo-emonev"><div style="float:left;width:140px;"> <img src="resources/images/logo-tegal.png" width=180px></div><div style="float:left;"><h3 class="x-logo-text-emonev">e-Monev</h3>
        <p class="x-logo-desc-emonev">Sistem Informasi Monitoring, <br> Pengendalian dan Evaluasi  <br/>  Perencanaan Pembangunan Kota Tegal</p></div></div>`},
        {
            ...
            items: [
                ...
                { xtype: "hiddenfield", fieldLabel: "p", name: "app", value: 'emonev' },
                ...
                { xtype: "passwordfield",revealable: true,listeners:{keydown:'eventKeydown'}, margin: '20 0 20 0', labelAlign: 'top', label: '<span style="color:#a1a5b7!important;font-weight:bold;">Password :</span>', name: "password", required: true, clearable: false, ui: 'logintext', cls: 'icon-textfield x-fa fa-key', placeholder: 'Password' },
                {
                    ...
                    items: [
                        ...
                        { xtype: "textfield", listeners:{keydown:'eventKeydown'},labelAlign: 'left',labelWidth:1,  name: "captcha", required: true, clearable: false, ui: 'logintext', margin: '5 0 0 10', placeholder: 'Kode Captcha ...', width: 130,height:40,  label:'.' },
                    ]
                },
        ...
        {
            xtype: 'formpanel', padding: 20, width: 450, 
            cls: 'login-panel', 
            bodyCls: 'login-body-panel', hidden: true, id: 'form-register-portal-data',jsonSubmit :true,
            defaults: {
