Ext.define('Admin.view.dak.FormDak', {
    ...
    xtype:'form-dak-kinerja',id:'form-dak-kinerja',
    jsonSubmit :true,
    ...
    bbar: [
        {xtype: 'button',ui : 'soft-red',text: 'Tutup',iconCls: 'x-fa fa-window-close',margin:'0 5 0 5',handler:function(btn){btn.up().up().up().up().up().destroy();},destIdx:2}, 
        {xtype:'spacer'},
