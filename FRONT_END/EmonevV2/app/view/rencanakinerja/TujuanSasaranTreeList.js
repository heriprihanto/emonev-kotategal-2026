		...
		items: [
			{
				...
				items: [
					...
					{ xtype: 'button', ui: 'soft-green', text: 'Approval BAPPERIDA', id: 'btn_verifikasi_lap_rencanakinerjapd_bappeda', shadow: true, iconCls: 'x-fa fa-check', margin: '0 5 0 5', handler: 'formVerifikasi_Show',mode:2, destIdx: 0},
