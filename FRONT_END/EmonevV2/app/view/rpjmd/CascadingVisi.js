Ext.define('Admin.view.rpjmd.CascadingVisi',
	{
		extend: 'Ext.grid.Tree', id: 'rpjmd-cascading-visi-misi',
		xtype: 'rpjmd-cascading-visi-misi',
		...
		columns: [
			...
			{ text: 'id', dataIndex: 'id', hidden: true },
			{
				...
				text: '<b>Visi / Misi / Tujuan / Sasaran</b>',
				width: '70%',
				sortable: true,
				dataIndex: 'uraian',
