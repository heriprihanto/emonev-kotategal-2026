Ext.define('Admin.view.rpjmd.Main', {
    extend: 'Ext.Container',
    margin: '0 0 0 0',cls:'container-modul',padding:20,
    scrollable: true,
    viewModel: {xclass: 'Admin.view.rpjmd.ViewModel'},
	controller: {xclass: 'Admin.view.rpjmd.Controller'},
    xtype:'rpjmd-mainview',
	
    items: [
        {
            xtype: 'component',
            html:'<div class="dt-entry__header"><i class="x-fa fa-calendar-check" aria-hidden="true"></i> RPJMD </div>',
        },
        
        {
            ...
            items: [		
                {title: '.:: OPD ::.' ,itemId: 'step-0',cls: 'card',hidden:true,
                    items:[{xtype:'rpjmd-cascading-visi-misi'}]
                },
