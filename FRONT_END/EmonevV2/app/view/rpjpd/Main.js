Ext.define('Admin.view.rpjpd.Main', {
    extend: 'Ext.Container',
    margin: '0 0 0 0',cls:'container-modul',padding:20,
    scrollable: true,
    viewModel: {xclass: 'Admin.view.rpjpd.ViewModel'},
	controller: {xclass: 'Admin.view.rpjpd.Controller'},
    xtype:'rpjpd-mainview',
	
    items: [
        {
            xtype: 'component',
            html:'<div class="dt-entry__header"><i class="x-fa fa-calendar-check" aria-hidden="true"></i> RPJPD </div>',
        },
        
        {
            ...
            items: [		
                {title: '.:: Visi Daerah ::.' ,itemId: 'step-0',cls: 'card',
                    items:[{xtype:'rpjpd-cascading-visi-misi'}]
                },
               
                {title: '.:: Sasaran Visi ::.' ,itemId: 'step-0xx',cls: 'card',
                    //items:[{xtype:'subpd-rencanacapkin-list'}]
                },
                
                
                {title: '.:: Arah Kebijakan ::.' ,itemId: 'step-1',cls: 'card',
