Ext.define('Admin.view.rfk.Rfk', {
    ...
    margin: '0 0 0 0',cls:'container-modul',padding:50,id:'container-rko-mainview',
    scrollable: true,
    ...
    items: [
        ...
        {
            xtype:'tabpanel',id:'rfk_tabpanel_00548799paosie',tabBar: {layout: {pack: 'start',overflow: 'scroller'}},margin:'30 0 0 0',cls:'tab-modulpanel-cl-hijau',height:PanelCompHeight-70,
            items: [		
