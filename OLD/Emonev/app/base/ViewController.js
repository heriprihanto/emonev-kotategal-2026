Ext.define('Admin.base.ViewController', {
	...
	hapusGridData:function(url, idX,store,scope) {
		Ext.Ajax.request({
			...
			success: function(response, opts) {
				...
				//console.dir(obj);
				scope.toastPesan('success','Data Berhasil Dihapus !! ::', 2000);
				store.reload();
			},
	   
			failure: function(response, opts) {
				scope.toastPesan('error','Hapus gagal, mohon koreksi lagi !', 2000);
			}
		});
	},
