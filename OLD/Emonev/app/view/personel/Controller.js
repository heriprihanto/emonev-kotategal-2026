...
Ext.define('Admin.view.personel.Controller', {
	...
	OpdList_itemClick:function (grid, records) {
		...
		Ext.fly('dt-entry__header_personel').update('<i class="x-fa fa-user" aria-hidden="true"></i> Data Personel :: ' + records.record.data.nama_pd +'');
	...
	formPersonel_Show:function (btn) {
		...
		var dialog = Ext.create({
			xtype: 'dialog',
			title: 'Data Personel',  shadow: 'true',width:500,height:400,
			items:[
				{xtype:'personel-form'}
			],
