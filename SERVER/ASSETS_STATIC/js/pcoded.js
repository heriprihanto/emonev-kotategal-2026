...
document.addEventListener("DOMContentLoaded", function () {
  togglemenu();
  if (
    document.querySelector("body").classList.contains("layout-6") ||
    document.querySelector("body").classList.contains("layout-7")
  ) {
    togglemenulayout();
  }
  menuclick();
  ...
  document
    .querySelector("#mobile-collapse")
    .addEventListener("click", function () {
      if (vw > 991) {
        if (
          document
            .querySelector(".pcoded-navbar:not(.theme-horizontal)")
          ...
          document
            .querySelector(".pcoded-navbar:not(.theme-horizontal)")
            .classList.add("navbar-collapsed");
        }
      }
    });
  ...
  function cfc(e) {
    document
      .querySelector(".header-chat .main-friend-chat")
      .insertAdjacentHTML(
        "beforeend",
        "" +
          ...
          '<div class="">' +
          '<p class="chat-cont">' +
          document.querySelector(".h-send-chat").value +
          "</p>" +
          "</div>" +
  ...
  function fsc() {
    ...
    document
      .querySelector(".main-chat-cont.scroll-div")
      .scrollTop(tmph.outerHeight());
  }
  ...
  if (
    !document
      ...
      .classList.contains("theme-horizontal")
  ) {
    var vw = window.innerWidth;
    if (!!document.querySelector(".navbar-content")) {
      if (
        ...
        document
          .querySelector(".pcoded-navbar")
          .classList.contains("menupos-static")
      ) {
  ...
  document
    .querySelector(".search-bar .btn-close")
    .addEventListener("click", function () {
...
function horizontalmenu() {
  ...
  if (
    ...
    if (vw < 992) {
      document
        .querySelector(".pcoded-navbar.theme-horizontal")
        .classList.remove("theme-horizontal");
    }
  }
}
...
function menuhrres() {
  if (document.querySelector("body").classList.contains("theme-horizontal")) {
    ...
    if (vw < 992) {
      setTimeout(function () {
        document
          .querySelector(".sidenav-horizontal-wrapper")
          .classList.add("sidenav-horizontal-wrapper-dis")
          .classList.remove("sidenav-horizontal-wrapper");
        document
          .querySelector(".theme-horizontal")
          .classList.add("theme-horizontal-dis")
          .classList.remove("theme-horizontal");
      }, 400);
    } else {
      setTimeout(function () {
        document
          .querySelector(".sidenav-horizontal-wrapper-dis")
          .classList.add("sidenav-horizontal-wrapper");
        document
          .querySelector(".sidenav-horizontal-wrapper-dis")
          .classList.remove("sidenav-horizontal-wrapper-dis");
        document
          .querySelector(".theme-horizontal-dis")
          .classList.add("theme-horizontal");
        document
          .querySelector(".theme-horizontal-dis")
          .classList.remove("theme-horizontal-dis");
      }, 400);
    }
    setTimeout(function () {
      if (
        document
          .querySelector(".pcoded-navbar")
          .classList.contains("theme-horizontal-dis")
      ) {
        document
          .querySelector(".sidenav-horizontal-wrapper-dis")
...
function togglemenu() {
  ...
  if (
    document
      .querySelector(".pcoded-navbar")
      .classList.contains("theme-horizontal") == false
  ) {
    if (vw <= 1200 && vw >= 992) {
      document
        .querySelector(".pcoded-navbar:not(.theme-horizontal)")
...
function menuclick() {
  ...
  if (!document.querySelector("body").classList.contains("minimenu")) {
    var elem = document.querySelectorAll(
      ".pcoded-navbar li:not(.pcoded-trigger) .pcoded-submenu"
    );
    for (var j = 0; j < elem.length; j++) {
    ...
    var pcsublinkclick = document.querySelectorAll(
      ".pcoded-inner-navbar > li:not(.pcoded-menu-caption) li"
    );
...
document
  ...
  .addEventListener("click", function (e) {
    ...
    if (vw < 992) {
      if (
        document.querySelector(".pcoded-navbar").classList.contains("mob-open")
      ) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .querySelector(".pcoded-navbar")
    .addEventListener("click tap", function (e) {
      e.stopPropagation();
    });
  document
    .querySelector(".pcoded-main-container")
    .addEventListener("click", function () {
      if (vw < 992) {
        if (
          document
            .querySelector(".pcoded-navbar")
            .classList.contains("mob-open") == true
        ) {
          document.querySelector(".pcoded-navbar").classList.remove("mob-open");
          document
            .querySelector("#mobile-collapse,#mobile-collapse1")
            .classList.remove("on");
        }
      }
    });
...
for (var l = 0; l < elem.length; l++) {
  ...
  if (elem[l].href == pageUrl && elem[l].getAttribute("href") != "") {
    ...
    if (document.body.classList.contains("tab-layout")) {
      var temp = document
        .querySelector(".pc-tabcontent.active")
...
function navfixsticky() {
  if (
    !document
      ...
      .classList.contains("headerpos-fixed")
  ) {
    if (
